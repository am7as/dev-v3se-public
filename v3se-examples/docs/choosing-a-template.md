...
|-------------------------------------------------------|------------------------------------|
| Just set up a V3SE-ready project with nothing fancy   | `01-foundation`                   |
...
- **New to V3SE / HPC**: `01-foundation` first. It only covers infra; you
  can swap in your actual science after you've seen it boot cleanly on
  laptop and Alvis.
- **Know HPC, new to V3SE**: skip to whichever Tier 1 matches your task.
  Read [c3se-primer.md](c3se-primer.md) alongside.
- **V3SE power user**: pick a Tier 2 or Tier 3 template, or clone one and
  rewire it.
