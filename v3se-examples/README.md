...
Chalmers C3SE's **V3SE environment** (Alvis GPU cluster + Cephyr
storage).
...
### Tier 3 — Advanced (production-grade V3SE references)
...
- [`../v3se-templates/`](../v3se-templates/) — just the scaffold (one project shape to clone).
