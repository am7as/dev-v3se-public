...
`summary.json` over CSV data, exercising C3SE's three canonical data
...
Now exercise the C3SE bind pattern. Edit
...
The C3SE canonical split: Cephyr for code, Mimer group for shared
